...
h5(bottom right black). or embed a web server ;)
</div>
...
<div class="slide bg-orange">
h1. WTF is not Webkit?!?

* WinMo
* Blackberry 
* Your parents old phone
</div>
...
<div class="slide bg-orange">
h1. the PhoneGap Philosophy one more time
...
<div class="slide bg-orange">
h1. terrible execution: PhoneGap risks

* gotta be real here
* big fucking surprise: ain't all roses
</div>
...
<div class="slide bg-orange">
h1. so, is this competition?

* lockin is not a goal of phonegap
* open code, open standards, as many devices as possible
</div>
...
* bondi (nice specs!)
* w3c device api working group (coming soon...)
</div>
